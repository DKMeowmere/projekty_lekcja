...
ocena.ocena_r = 3.5;
cout << sizeof(ocena) << endl; // 4
cout << sizeof(ocena.ocena_r) << endl; // 4 unia zajmuje tyle pamięci co jej największe pole
// Wyświetlenie wartości elementu członkowskiego ocena_r:
cout << ocena.ocena_r << endl; // 3.5
cout<<ocena.ocena_c;//0 to pole przyjmuje wartość 0 bo wstawiłem do innego pola unii. W strukturze miałbym tą wartość, ale struktura zajmuje więcej pamięci
return 0;
}