...
public:
    ...
    ~Pracownik(){cout<<"jestem DESTRUKTOREM klasy bazowej"<<endl;}
    Pracownik() { cout << "bezparametrowy bazowej" << endl; }; // konstruktor domyślny
...
{
public:
~Nauczyciel() {cout<<"jestem DESTRUKTOREM klasy pochodnej"<<endl;}
    string przedmiot;
    // DEFINICJE KONSTRUKTORÓW:
    Nauczyciel() { cout << "bezparametrowy pochodnej" << endl; }; // konstruktor domyślny
    /* UWAGA
    ...
    // cout<<"parametrowy pochodnej"<<endl;
    // }
    /* UWAGA
