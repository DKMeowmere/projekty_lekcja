...
{
  try
  { // początek bloku kodu, w którym jest realizowana inspekcja kodu źródłowego
    // Dane wejściowe:
  ...
  { // nagłówek procedury obsługi wyjątku przechwytywany jest typ zmi9ennej,a nie jej nazwa
    cout << "Błąd! Próba dzielenia przez zero!" << err << endl;
    /* UWAGA
